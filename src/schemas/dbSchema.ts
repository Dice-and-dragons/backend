import { pgTable, text, timestamp, integer, boolean, json, varchar, smallint } from 'drizzle-orm/pg-core';
import { PositionType, CharacterType, SizeType, RoomsType } from '@schemas/types';
...
export const characters = pgTable('characters', {
  id: text('id').primaryKey(),
  position: json('position').$type<PositionType>().notNull(),
